        ...
        >
            {
                hotels.map((hotel,index) => 
                    <SwiperSlide key={index}>
                        <img className='w-full h-[200px] rounded-lg transform transition-transform duration-500 hover:scale-110' src={hotel.img} alt="" />
                        <div className='space-y-2 pt-2'>
                        <h2 className='text-sm text-gray-900 text-[18px] font-bold'>{hotel.title}</h2>
